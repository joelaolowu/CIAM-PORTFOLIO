...
OKTA CUSTOMER IDENTITY CLOUD (FORMERLY AUTH0) was decided because it's the cheapest especially being free for the first thirty days without Bank details. 





Task 1: Create Your Auth0 Free Tenant
...
Open a browser and go to auth0.com
Click Start Building for Free or Sign Up
Sign up using your email address (not Google SSO - we want email login as the starting point)
